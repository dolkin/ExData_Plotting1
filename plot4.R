...
with(dt, plot(DateTime, Global_active_power, type = "s",
              xlab = NA, ylab = "Global Active Power"))

with(dt, plot(DateTime, Voltage, type = "s",
              ylab = "Voltage"))
...
legend("topright", inset = 0.01, lty = 1, cex = 0.8, 
       box.lwd = NA, col = c("black", "blue", "red"), 
       legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"))

with(dt, plot(DateTime, Global_reactive_power, type = "s"))
